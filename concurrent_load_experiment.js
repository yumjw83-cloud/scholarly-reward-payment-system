 ...
 *
 * 목적:
 *   동시 트랜잭션 수(1, 5, 10, 20, 50, 70, 100)에 따른 EscrowCreate 지연시간
 *   변화를 측정한다. 4.3.4절 부하 한계 추정의 수식 기반 결과를
 *   실측값으로 보완한다.
 *
 * 실험 설계:
 *   - 동시 제출 수: CONCURRENCY_LEVELS = [1, 5, 10, 20, 50, 70, 100]
...
const CONCURRENCY_LEVELS  = [1, 5, 10, 20, 50, 70, 100]   // 동시 제출 수
const REPEATS_PER_LEVEL   = 10                // 조건당 반복 횟수
const ESCROW_AMOUNT_XRP   = "1"
const FINISH_AFTER_SEC    = 5                 // Time 모드 잠금 시간
const OUTPUT_CSV          = "concurrent_load_results.csv"
const OUTPUT_TXT          = "concurrent_load_results.txt"
